...
function getWeather() {
    ...
    axios.get(`https://api.openweathermap.org/data/2.5/forecast?${cityValue}&units=metric&appid=dd942f90e8c353bb0a469a7db5bbb3d4`).then((res) => {
        weatherData.value = [{
            ...
            pic: "/src/assets/big/" + res.data.list[0].weather[0].main + ".png",
            date: date,
            ...
            pic2: "/src/assets/min/" + res.data.list[2].weather[0].main + ".png",
            ...
            pic3: "/src/assets/min/" + res.data.list[4].weather[0].main + ".png",
